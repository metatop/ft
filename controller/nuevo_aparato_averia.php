...
class nuevo_aparato_averia extends fs_controller
{
    ...
    {
        parent::__construct(__CLASS__, 'Nuevo Aparato Averia', 'Aparatos', FALSE, FALSE);
    }
            ...
            if  (is_null($this->tablaaparatos->marca)) 
            {
               ...
               if ( $this->tablaaparatos->save() )
               {
                    ...
                    { 
                     ...
                     $this->new_message('<h3>El nuevo aparato se ha guardado correctamente</h3> <h4>Ahora puedes:</h4>');
