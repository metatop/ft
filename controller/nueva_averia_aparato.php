...
class nueva_averia_aparato extends fs_controller
{
    ...
    {
        parent::__construct(__CLASS__, 'Nueva Avería por aparato', 'Averias', FALSE, FALSE);
    }
            ...
            if ( $this->tablaaverias->save() )
             {
                ...
                //his->new_message('<h5><a href="index.php?page=listado_aparatos">VOLVER a Buscar Soluciones de Averías</a></h5>');
                //$this->new_message('<h5>Añadir otra solución de Avería a éste aparato, para ello pulsa el botón mas abajo</h5>');
                //$this->new_message('<h5>Añadir un documento, archivo o imagen, para ello pulsa el botón mas abajo</h5>');
             }
            else
