...
/**
 * Controlador de listado de averias por aparato
 *
 * @author Tiz
 */
...
class listado_averias_por_aparato extends fs_controller
{
    ...
    {
        parent::__construct(__CLASS__, 'Listado Averias por Aparato', 'Averias', FALSE,FALSE);
    }
    ...
    protected function private_core() 
   {
        ...
        //if($this->query != '')
        //{    
        //$this->lista_averias = $this->tablaaverias->busca_por_idaparato($this->query, $this->offset);
        
        //}   
        //else
        //$this->lista_averias = $this->new_message('Solo se busca por ID de aparato');
    
        
        if( isset($_GET['cod']) )
        {    
        $this->lista_averias = $this->tablaaverias->busca_por_idaparato($_GET['cod'], $this->offset);
